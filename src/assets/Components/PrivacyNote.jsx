...
Welcome to Rockstar Games! We are a global gaming company headquartered in Los Angeles with offices and operations around the world. Rockstar Games, Inc. and its subsidiaries take your privacy and the protection of your personal information seriously. This Privacy Notice explains what personal info Rockstar Games collects when you visit or use the Rockstar Services, as well as ways we might use or disclose it. By “personal info,” we mean any information from or about an identified or identifiable person, including information that Rockstar Games can associate with an individual person. We’re only describing our own practices—this Notice doesn’t cover the practices of third parties we don’t own or control, including other companies you might interact with on or through the Rockstar Services (see Third-Party Websites and Services).
...
When we say “Rockstar Services,” we mean our games, websites, applications, entertainment content, and services that link to this Notice, regardless of how you access or use them or engage with us, including through mobile devices or offline such as by phone. Your use of the Rockstar Services is also subject to the Terms of Service in your region (including its provisions regarding limitations on damages, resolution of disputes, and application of governing law). Please read this entire Notice to make sure you understand it. You should also read the Terms of Service carefully, and make sure you understand and agree to them before using the Rockstar Services.
...
The particular types of personal info we gather usually depends on how you interact with us, like which Rockstar Services you use and how you use them.

Information that is de-identified, aggregated, or anonymized so that it cannot be used to identify an individual is not considered personal info. If we de-identify, aggregate, or anonymize your personal info (for example, by deleting your email address, Rockstar ID, and other identifiers), we commit to maintain and use it in such form without attempting to re-identify it.

A. Personal Info You Provide
Summary: We collect personal info you choose to provide. You don’t have to disclose personal info when we ask you for it, but if you decline, you might not be able to access certain Rockstar Services or take advantage of their full functionality.

We collect personal info you provide on the Rockstar Services, including:

Your email address, date of birth, in-game name (e.g. Rockstar ID), and similar contact info (like when you register for an account);
Your username, password, and other details that help us secure and provide access to the Rockstar Services (like when you login to our games or websites);
Your name, billing address, telephone number, payment method, and other details to help process purchases you make (like when you buy Rockstar Points or shop at our Merch Store);
...
The Rockstar Services also offer social features like voice and text chat. When you use these features, the personal info you disclose may be seen or overheard by others. We may collect and use the personal info you provide, including to enforce our Terms of Service (such as described in Anti-Cheat & Fraud Prevention and Communication & Player Behavior below), and in some cases it may also be collected or used by others without your express knowledge (for example, if you’re chatting with another player while they stream a match).

When you play multiplayer games like League of Legends, note that some personal info will be publicly accessible to others, such as your game statistics and performance. We may record gameplay and related personal info (such as your in-game name, build order, and in-game actions), and replay or otherwise make it available to other players without further notice to you. For example, players can watch each other play League of Legends using Spectator Mode, and we may use gameplay footage to help promote or improve the Rockstar Services.

If you disclose any personal info relating to other people to us or to our service providers in connection with the Rockstar Services, you represent that you have the authority to do so and to permit us to use the personal info in accordance with this Notice.

Send to top

B. Personal Info We Collect Automatically
Summary: We automatically collect some personal info about how you interact with and navigate the Rockstar Services, as well as the device and software you use to do so.

Common examples include personal info regarding:

Your use of the Rockstar Services (such as timestamps, clicks, scrolling, browsing times, browsing heatmaps, searches, referral/exit pages, and activity and interactions on our websites and in our game clients, including chat logs);
...
Your connection to the Rockstar Services, including details about the network and software you’re using (such as browser type and version, operating system name and version, ISP, and your preference settings); and
How the Rockstar Services perform, including problems you may encounter (such as loading errors and response times).
...
We obtain personal info from third party integrations if you activate their services in connection with the Rockstar Services. For example, if you link your Facebook account with your Rockstar Games account, Meta may disclose personal info to us in accordance with Facebook’s privacy notice and your Facebook privacy settings. Your privacy settings on the third party’s service control what personal info they can disclose to us—it can include personal info like your name, profile picture, gender, age range, username, language, country, your friends and other personal info you have made available on the platform. Please make sure you’re comfortable with what they might disclose by reviewing their posted policies, and if applicable, modifying your privacy settings directly on their service.
We obtain info from third parties in the analytics and advertising ecosystem to help support our marketing initiatives, improve the Rockstar Services, and better manage our ad campaigns (like by displaying more personalized ads and measuring how effective they are). To learn more about these companies, see Analytics & Interest-Based Ads.
We obtain info from vendors to help us identify from where you’re using the Rockstar Services (like your approximate location based on your IP address). This helps us, for example, process purchases (like assessing tax obligations), prevent fraud or abuse of the Rockstar Services (such as identifying suspicious transactions or activity), and customize your visit (like displaying the Rockstar Services in your local language).
We also receive personal info from third-party platforms (like the Apple App Store or Google Play) if you download the Rockstar Services (such as the Rockstar Mobile app) on your mobile device. This might include, for example, technical details (like device IDs) and the fact that you’ve downloaded one of our apps. We also obtain personal info from third-party gaming platforms (like Microsoft or Sony) in connection with your use of the Rockstar Services.
...
Depending on your use of the Rockstar Services, the following categories of personal info may have been collected and disclosed for a business purpose in the preceding 12 months:
...
Commercial info, including interaction with the Rockstar Services, customer support info, preferences, interests, hobbies, favorite games, purchase history, and payment method
Internet or other electronic network activity info, including the use of the Rockstar Services (timestamps, clicks, scrolling, browsing times, browsing heatmaps, searches, referral/exit pages, and activity and interactions on our websites and in our game clients, including chat logs), computer or device (processing capabilities, manufacturer and model, language and other regional settings, screen resolution and similar settings, and IP address (which may be used to infer general location at a city or country level), connection to the Rockstar Services (browser type and version, operating system name and version, ISP, and your preference settings), how the Rockstar Services perform (loading errors and response times), third-party platform and usage data, and advertising and analytics info
...
II. HOW WE COLLECT PERSONAL INFO
As discussed above (Personal Info We Collect Automatically), we automatically collect some personal info about how you use and navigate the Rockstar Services. We may combine this personal info with other personal info we gather from or about you as described in this Notice, including to enforce our Terms of Service.

A. Cookies & Related Technologies
Summary: We use our own servers and technologies like cookies to automatically collect and store info about how you interact with the Rockstar Services, as well as the device you use to do so.
...
The Rockstar Services use cookies, web beacons, and similar technologies to automatically collect, store, and read files on your device. They may be delivered in a first-party (i.e., by Rockstar Games) or third-party (i.e., by other companies) context. These tools help the Rockstar Services work and operate more efficiently, as well as collect info about how you interact with us (see Personal Info We Collect Automatically).

We also use our servers in connection with these technologies to collect info about the ways you interact with the Rockstar Services and store it in log files. This may include, for example, info that your device, browser, or operating system sends to us when you access the Rockstar Services (like device IDs, IP addresses, and hardware or software specifications) and details about how you use your Rockstar Games account (like the particular features you use, your in-game interactions and statistics, and other similar personal info).

We use personal info gathered through our servers and technologies like cookies in accordance with this Notice, including:

To monitor, secure, and maintain the Rockstar Services (like preventing fraud);
...
To otherwise manage our relationship with players and provide the Rockstar Services under the Terms of Service (including to improve our services and ensure a more positive and fair gaming environment, such as described in Anti-Cheat & Fraud Prevention and Communication & Player Behavior below).
...
Please note that disabling technologies like cookies may prevent you from using the full functionality of the Rockstar Services and the Rockstar Services may not work as we intended.
...
as is necessary to perform the Terms of Service and to provide the Rockstar Services;
...
Summary: We use the personal info we collect (both individually and in combination with other personal info collected under this Notice) to help us operate our business, provide and improve our products and services, communicate with you, and advertise effectively. The particular ways we use your personal info often depend on how you choose to use the Rockstar Services.

Some of the most common examples of how we use personal info include:

To provide the Rockstar Services to you, respond to inquiries, fulfill requests, and process transactions (like helping you create an account, find a match, and resolve Player Support issues). We engage in these activities to manage our contractual relationship with you and, where relevant, to comply with a legal obligation (e.g. related to payment transactions) or based upon our legitimate interest in doing so;
To deliver and tailor our communications with you, like by sending you important account-related announcements or promotional communications that we believe may interest you (for details about managing your communication options, check out Your Rights, Choices, and Controls below). We engage in these activities with your consent (where required by law), where we have a legitimate interest (e.g. to promote the Rockstar Services and keep you interested in them through personalized messages) or, in the case of account-related announcements, to perform our contract with you;
To administer surveys, contests, sweepstakes, competitive game modes, and similar offerings (such as confirming your eligibility or sending you a prize if you win). We engage in these activities to manage our contractual relationship with you, or for our legitimate interest (e.g. to promote the Rockstar Services and keep you interested in them);
To monitor, analyze, protect, test, and improve our services and operations (like measuring how the Rockstar Services perform, tracking usage patterns, and fixing bugs or errors). We engage in these activities to manage our contractual relationship with you, to comply with a legal obligation (e.g. to keep the Rockstar Services secure), and/or because we have a legitimate interest (e.g. understanding how the Rockstar Services are used, keeping them secure, improving them, and developing new products);
To research and better understand the Rockstar Services and how they’re used. We engage in these activities with your consent and/or because we have a legitimate interest (e.g. understanding how the Rockstar Services are used, keeping them secure, improving them, developing new products, and understanding the impact and reach of the Rockstar Services);
To advertise and promote the Rockstar Services, including displaying advertising related to the Rockstar Services on third-party websites and platforms, improving, developing, and implementing marketing campaigns, analyzing and measuring the effectiveness of those ads and campaigns, and showing you ads that are most relevant to you about the Rockstar Services. We engage in these activities with your consent or where we have a legitimate interest (marketing our and others’ products and services and understanding the effectiveness of our marketing campaigns). For information on how to opt out of personalized advertising on third-party platforms, please see Your Rights, Choices and Controls;
To personalize your experience with the Rockstar Services, including by presenting content or features better tailored to your interests. We engage in these activities with your consent or where we have a legitimate interest (e.g. improving our Rockstar Services by making them more personalized);
To improve and provide updates for the Rockstar Services (like patching our games and releasing new features). We engage in these activities to manage our contractual relationship with you, to comply with a legal obligation, and/or because we have a legitimate interest (e.g., understanding how the Rockstar Services are used, keeping them secure, improving them, developing new products, and understanding the impact and reach of the Rockstar Services);
...
To facilitate use of or integration with the Rockstar Services, social sharing, third-party partnerships, and related functionality (such as supporting chat features). We engage in these activities with your consent or where we have a legitimate interest (e.g. increasing customer engagement with our products and the Rockstar Services).
...
Securely operate the Rockstar Services (like stopping attacks on our systems);
...
To the Rockstar Games developer community via the Rockstar Games API so they can help contribute to the player experience. Please note that your in-game name (e.g. Summoner Name or Rockstar ID) and gameplay statistics (like your match history, item builds, and average number of kills and deaths) are viewable to others and may be disclosed through the API.
...
Securely operate the Rockstar Services (like stopping attacks on our systems), based on Rockstar Games’ players’ and non-players’ legitimate interest in the Rockstar Services being a safe and secure environment;
Protect players and non-players (such as to help prevent serious injury, abuse, or crime), based on Rockstar Games’ players’ and non-players’ legitimate interest in the Rockstar Services being a safe and secure environment; and
...
Some of the personal info we collect is used and disclosed for analytics and advertising purposes. This personal info may be collected through cookies and other technologies incorporated into the Rockstar Services as described in Cookies & Related Technologies. In addition to the technologies we operate, we incorporate technologies offered by service providers. For example, we use technologies from analytics providers (like Google Analytics) to help evaluate and report on the use of Rockstar Services and technologies from ad partners (like Meta) to support our marketing and advertising efforts. Some of these technologies are able to track your activities across non-affiliated services and obtain or infer personal info about you for purposes of showing you relevant advertising based on your preferences and interests.
...
To enable us to monitor compliance with our policies and terms, we develop template patterns of inappropriate behavior (e.g. abuse, hate speech, cheating, threats, offensive or inappropriate names), which we consider indicative of prohibited behaviors. We do this based upon an analysis of social features like voice and text chat, including files uploaded or exchanged through chat, and actual behaviors when you use the Rockstar Services. We grade these patterns of inappropriate behavior based upon their severity with different consequences (e.g. temporary or permanent account restrictions or communications restrictions) for players based upon how serious their conduct is. If another player makes a complaint about your behavior, our advanced automated tools use these patterns of inappropriate behavior and grading system to compare your behavior over time with these patterns of inappropriate behavior and, if it is determined that you have engaged in inappropriate behavior, make a decision as to the consequences for you of your behavior. This helps us enforce our policies and terms, secure the Rockstar Services, detect and prevent unauthorized activity, maintain the competitive integrity of the Rockstar Services, and prevent illegal, fraudulent, offensive, inappropriate, or other harmful behavior.
...
F. Anti-Cheat
We always seek to offer players a fair, fun, and competitive gaming experience on the Rockstar Services. Our Terms of Service strictly prohibit use of unauthorized third-party programs that interact with the Rockstar Services, including mods, hacks, cheats, scripts, bots, trainers, and automation programs. As described in Communication & Player Behavior, we may use anti-cheat and fraud prevention technologies (such as anti-cheat software that may run in the background of your device) that may make automated decisions (such as temporary or permanent account suspensions, communications restrictions, removal of content, or limited access to game content) based on our monitoring of social features like voice and text chat and actual behaviors when you use the Rockstar Services (see Personal Info We Collect). We engage in these activities to manage our contractual relationship with you, comply with legal obligations (e.g. to keep the Rockstar Services secure), and/or because we have a legitimate interest (e.g. understanding how the Rockstar Services are used, maintaining their integrity, and improving them).
...
V. INTERNATIONAL PERSONAL INFO PROCESSING
Summary: We’re a global gaming company with operations around the world. When you use the Rockstar Services, your personal info may be processed anywhere we, our partners, or service providers do business, including the United States, providing that adequate technical and organizational measures are in place to ensure the security of your personal info.

(1) OPERATING THE Rockstar SERVICES. Depending on your location, the Rockstar Services are operated by or on behalf of Rockstar Games from:
...
For important details regarding which laws apply to your use of the Rockstar Services and any disputes with Rockstar Games, be sure to check out the Terms of Service. See Contact Us to see who is the Rockstar Games entity or entities which control and are responsible for your personal info.
...
We’ve implemented and maintain a framework consistent with applicable law and this Notice for transfers of personal info outside the country of collection, including, for example, through the use of Standard Contractual Clauses when we transfer personal info outside of the EEA and the UK. You can learn more about EU Standard Contractual Clauses on the USAan Commission website [ec.europa.eu/info/law/law-topic/data-protection/] and to request a copy of them Contact Us. We may also need to transfer your personal info to provide the Rockstar Services to you in accordance with the Terms of Service. By using the Rockstar Services, you acknowledge that we may transfer your personal info to (and process it in) countries outside of your country of residence, each of which may have different privacy rules than your country.
...
VI. YOUR RIGHTS, CHOICES AND CONTROLS
Summary: You have rights and choices regarding your use of the Rockstar Services and the ways we process personal info. Since you can interact with us in many different ways, the particular controls available to you often depend on the nature of our relationship.

You can use many parts of the Rockstar Services without ever creating an account, purchasing our products or services, or otherwise submitting personal info like your name or email address to us. If you do choose to visit or use the Rockstar Services, we generally retain the related personal info as long as your account is active or as is otherwise necessary to provide the Rockstar Services, operate our business (including for legitimate purposes like complying with our legal obligations, managing internal books and records, preventing fraud, resolving disputes, and enforcing our contracts and terms, such as this Notice and the Terms of Service) or to achieve the purposes set out in this Notice, unless a longer retention period is permitted or required by law.

The precise periods for which we keep your personal info vary depending on the nature of the personal info, why we need it and relevant legal or operational retention needs. Factors we consider in determining these periods include the minimum required retention period prescribed by law or recommended as best practice, the period during which a claim can be made with respect to a contract or other matter, whether the personal info has been aggregated or pseudonymized, and other relevant criteria. For example, the retention period applicable for your personal info needed to provide the Rockstar Services to you (such as accessing the games) is limited to how long you maintain an account. When your account is deleted, Rockstar will delete the relevant personal info for that purpose (providing the service to you) but will keep some account-related personal info (your match history, for instance) for other defined purposes such as security and fraud detection. As another example, communications logs/history info is retained at minimum for a period of time sufficient to allow any complaints to be filed after a match, and if such a complaint is filed, for a period of up to two years from their creation or a period of time sufficient to investigate the complaint. This is to enable Rockstar to properly investigate infringements of our rules and policies such as fraud, cheating and disruptive behavior.
...
If you don’t want to take advantage of the services that third-party analytics and advertising companies provide on the Rockstar Services, you may be able to opt out (or opt in if you are in the EEA or UK) of some of them by visiting YourAdChoices.com or Optout.NetworkAdvertising.org, or if you’re located in the EEA, UK, or Canada, YourOnlineChoices.eu or YourAdChoices.ca respectively. For a representative list of third-party advertising and analytics partners that operate on the Rockstar Services, as well as details about how to opt out (or opt in if you are in the EEA or UK) to the extent applicable, see Cookies & Related Technologies.
...
Note that asking us to delete personal info or refrain from processing it may also result in us being unable to make certain Rockstar Services available to you, in which case you’ll no longer be able to access those Rockstar Services. If you withdraw your consent (including for marketing purposes), it does not affect the lawfulness of what we did up until that point. We may also retain certain personal info associated with your account for purposes like complying with our legal obligations, managing internal books and records, preventing fraud, resolving disputes, and enforcing our contracts and terms, such as this Notice and the Terms of Service.
...
However, please note that no server, communications network, or data transmission over the Internet is 100% secure. The Rockstar Services are no exception. We can’t guarantee the security of any personal info transmitted through the Rockstar Services and make no assurances about our ability to prevent any such loss or misuse.
...
VIII. UPDATES AND REVISIONS
We’ll update this Notice from time to time to reflect changes in technology, law, our business operations, or any other reason we determine is necessary or appropriate. When we do make changes, we’ll update the “Last Modified” date at the top of the Notice and post it to the Rockstar Services. If we make material changes to the Notice or the ways we process personal info, we’ll provide you additional notice as well (such as by prominently posting a notice of the changes on the Rockstar Services before they take effect or sending you a notification directly).
...
If you have any questions or concerns about this Notice or our privacy practices, please send them to our Data Protection Officer via email at dpo@Rockstargames.com or via postal mail at the appropriate address listed below.
