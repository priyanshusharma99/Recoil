...
These terms of service (the “Terms”) set out the terms and conditions by which Rockstar Games offers you access to use and enjoy our games, apps, websites and other services (the “Riot Services”). Rockstar Games is a global gaming company headquartered in Los Angeles with offices and operations around the world. When we say “Rockstar Games,” we’re referring to the Rockstar Games entity responsible for providing the Riot Services in your region (see Section 18, below) and these Terms are an agreement between you and that entity.
...
GOVERNING LAW
DISPUTE RESOLUTION
ADDITIONAL TERMS APPLICABLE TO RIOT SERVICES
RIOT LEGAL ENTITIES
MISCELLANEOUS
1. YOUR ACCOUNT
...
We send account, legal and service related notices to the email address registered to your account. These notifications may be really important (e.g., a notification that we intend to terminate your account for inactivity) so you must keep the email address associated with your account current and (if we ask) verified. If you create an account by logging in to the Riot Services with a social media account, your Rockstar Games account email will be the email address associated with that social media account.
...
doing so would be in the best interests of our community or the Riot Services or is required for upholding a third party’s rights;
we have stopped offering the Riot Services in your region (though we’ll normally post reasonable advance notice on our website, app or game if we plan to stop offering a material core feature of a game or all of the Riot Services in your region);
...
Violating any law, rule or regulation by or while using the Riot Services;
...
Deliver this notice (“Notice”), with all items completed, to Rockstar Games’ Copyright Agent to the address of the Rockstar Games entity responsible for providing the Riot Services in your region (see Section 18). Be sure to mark it “Attn: Copyright Agent” (and not “Attn: Legal Dept) so it gets to the right person quickly. You can send your Notice instead by email to: copyright@riotgames.com. This email address is intended solely for the receipt of copyright take-down notices and not for general inquiries or requests of Rockstar Games. Attachments cannot be accepted at the email address for security reasons. Accordingly, any Notice submitted electronically with an attachment will not be received or processed.
...
The Riot Services are provided to you on an “as is” and “as available” basis without warranties or representations of any kind, express or implied. You assume all responsibility for your use of the Riot Services. To the fullest extent permitted by applicable law, Rockstar Games disclaims all warranties, express or implied, which might apply to the Riot Services, including implied warranties of title, non-infringement, merchantability, fitness for a particular purpose, any warranties that may arise from course of dealing, course of performance or usage of trade, and any warranties as to the accuracy, reliability or quality of any content or info contained within the Riot Services.
...
15.1. What law applies to these Terms or if we get into a dispute? (That depends on where you live and what Rockstar Games entity provides you with Riot Services.)
...
The Tokyo District Court shall have the exclusive jurisdiction in the first instance over any dispute between Rockstar Games and you arising out of, or in connection with, these Terms or any Riot Services.
...
These Terms are an agreement between us and you, and not between you and the Third Party Platform. As between Rockstar Games and the Third Party Platform, Rockstar Games is solely responsible for any Riot Services.
...
If a third party claims any of the Riot Services infringes another party's intellectual property rights, as between the Third Party Platform and Rockstar Games, the Third Party Platform will not be responsible for the investigation, defense, settlement and discharge of any such claim.
The Third Party Platform and its subsidiaries are third-party beneficiaries of these Terms as they relate to your license to the Riot Services. Upon your acceptance of these Terms, the Third Party Platform will have the right (and will be deemed to have accepted the right) to enforce this Section 17 and Section 19.9 as related to your license of the Riot Services against you as a third-party beneficiary.
...
Rockstar Games is composed of many different legal entities that operate worldwide. These Terms are an agreement between you and the specific Rockstar Games entity responsible for providing the Riot Services in your region, as set forth below.
...
If you have any questions concerning the Riot Services, or if you would like to contact us for any other reason, please contact Rockstar Games support at support@riotgames.com.
...
You agree that no joint venture, partnership, employment, or agency relationship exists between you and Rockstar Games as a result of these Terms or your use of the Riot Services.
...
These Terms begin on the date you first accept them and last for as long as you use or maintain an account on the Riot Services. However, Sections 2.3, 3.2, 4.3, 4.4, 4.5, 5.1, 6, 8, and 13-18 inclusive, shall survive the termination of these Terms.
