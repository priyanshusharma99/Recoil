  ...
  return (
    <div>
      ...
      >
        ...
        <div className='w-full h-full bg-black svg top-0 left-0 z-100 overflow-hidden'>
        ...
        {showContent && (
          <>
            ...
            <div className="main-continued w-full">
              ...
              <div className="h-screen w-full justify-center flex items-center bg-[#000000]">
                <Characters />
              </div>
      ...
      <div className='cursoro fixed top-0 left-0 w-2.5 h-2.5 bg-white rounded-full'></div>
